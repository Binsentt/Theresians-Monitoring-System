...
const { applyReleaseMigrations, RELEASE_MIGRATIONS } = require('./releaseMigrations');

test('release manifest includes the versioned telemetry contract migration', () => {
  assert.deepEqual(RELEASE_MIGRATIONS.at(-1), { version: 21, file: '021_game_telemetry_contract.sql' });
});
