...
test('lesson Question Count accepts teacher-entered whole numbers from 1 through 50', () => {
  ...
  assert.equal(parseLessonQuestionCount('51').error, 'Question Count must be a whole number between 1 and 50.');
});
