...
// ================================================================================
// FILE: C:\Users\vince\Downloads\Theresian's Quest- Web\capstone\src\components\Modal.js
// ================================================================================

import React from 'react';
import '../styles/modal.css';

export default function Modal({ title, message, onClose, type = 'info', buttons = null }) {
  let defaultButtons = [];
  
  if (type === 'confirm') {
    defaultButtons = [
      { label: 'Cancel', onClick: () => onClose(false), className: 'btn-secondary' },
      { label: 'Confirm', onClick: () => onClose(true), className: 'btn-primary' }
    ];
  } else {
    defaultButtons = [{ label: 'OK', onClick: () => onClose(), className: 'btn-primary' }];
  }
          ...
          {activeTab === '' && (
            <div className="settings-menu">
              ...
              <div className="menu-options">
                <button className="menu-btn" onClick={() => setActiveTab('profile')}>
                  👤 My Profile
                </button>
                <button className="menu-btn" onClick={() => setActiveTab('password')}>
                  🔒 Change Password
                </button>
                <button className="menu-btn" onClick={() => setActiveTab('appearance')}>
                  <GearIcon /> Appearance
                </button>
            ...
            <div className="settings-section">
              <div className="section-header">
                <button
                  ...
                  onClick={() => { setActiveTab(''); setShowMenu(true); }}
                >
                  ← Back to Menu
                </button>
                <h2>My Profile</h2>
